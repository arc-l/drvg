...
// Uncomment to generate single-iteration scripts in build/dynamicrvgdebug.
#define WRITE_DYNAMIC_RVG_SINGLE_ITERATION
...
#ifdef WRITE_DYNAMIC_RVG_SINGLE_ITERATION
